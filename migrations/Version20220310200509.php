 ...
 */
final class Version20220310200509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abstract_content (id INT AUTO_INCREMENT NOT NULL, series_id INT DEFAULT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(50) NOT NULL, thumbnail VARCHAR(100) NOT NULL, release_date DATE NOT NULL, short_description VARCHAR(200) DEFAULT NULL, long_description VARCHAR(500) DEFAULT NULL, discr VARCHAR(255) NOT NULL, season_number SMALLINT DEFAULT NULL, episode_number SMALLINT DEFAULT NULL, INDEX IDX_5C7256395278319C (series_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
